      ...
      <div className="landing-container">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            ...
            <br />
            <span className="gradient-text">práctica legal</span>
          </h2>
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              {/* Card */}
              <div className="h-full bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 hover:shadow-2xl transition-all hover:-translate-y-2 border border-gray-200 dark:border-gray-700">
                {/* Icon */}
                ...
                {/* Hover glow effect */}
                <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} rounded-2xl opacity-0 group-hover:opacity-10 transition-opacity pointer-events-none`}></div>
              </div>
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold text-lg hover:shadow-xl hover:scale-105 transition-all"
          >
